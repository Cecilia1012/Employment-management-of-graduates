...
include("../html/teacher_edit.html");
...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	{
		include("conn.php");
		$sql="SELECT ID,nickname,realname,sex,phonenum,email,college,class,year FROM teachers WHERE isuse=1 AND ID='$editId'";
		...
		$sql2="UPDATE login SET question='$problemEditT',answer='$answerEditT' ,realname='$trueNameEditT' WHERE ID='$editId'";
		...
		$sql3="UPDATE teachers SET nickname='$nichengEditT',sex='$sex',phonenum='$phoneNumEditT',email='$emailEditT',college='$departmentEditT',class='$classEditT',year='$yearEditT',realname='$trueNameEditT' WHERE ID='$editId'";
